...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'img_customers'
        db.create_table(u'home_img_customers', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('image_url', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'home', ['img_customers'])


    def backwards(self, orm):
        # Deleting model 'img_customers'
        db.delete_table(u'home_img_customers')
    ...
    models = {
        ...
        u'home.img_customers': {
            'Meta': {'object_name': 'img_customers'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
